...
from genomicfeatures import GenomicFeaturesMethods
# from pyranges.genomicfeatures import _tss, _tes
from subset import get_string, get_slice, get_tuple
from methods import _cluster, _subtraction, _set_union, _set_intersection, _intersection, _nearest, _coverage, _overlap_write_both, _overlap, _tss, _tes, _jaccard, _lengths, _tile
...
class PyRanges():
    ...
    def jaccard(self, other, strandedness=False):
